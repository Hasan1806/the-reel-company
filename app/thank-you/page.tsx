    ...
    <div className="thank-you-page-root">
      ...
      <main className="thank-you-main">
        <div className="thank-you-card">
          ...
          {/* Heading */}
          <h1 className="thank-you-title">Thank You for Your Enquiry</h1>
          ...
          {/* Action CTA: Single Centered WhatsApp Button */}
          <div className="thank-you-actions thank-you-actions-single">
            <a
              ...
              className="btn btn-red thank-you-btn-primary thank-you-btn-whatsapp"
            ...
            <Link href="/" className="thank-you-btn-return" style={{ marginTop: '1rem', display: 'inline-flex', alignItems: 'center', gap: '0.5rem', color: 'rgba(255,255,255,0.7)', fontSize: '0.9rem', textDecoration: 'none', transition: 'color 0.2s' }}>
