            ...
            <div className="footer-cta-content">
              ...
              <div className="footer-cta-buttons" style={{ marginBottom: "2.25rem" }}>
                ...
                <a
                  ...
                  className="btn btn-off-white btn-lg footer-primary-cta-btn"
                  style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', justifyContent: 'center' }}
                >
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="#25D366">
                    <path d="M12.01 2.002c-5.512 0-9.998 4.486-9.998 9.998 0 1.956.554 3.829 1.603 5.426L2.3 22.183l4.896-1.282c1.554.957 3.332 1.463 5.178 1.463h.004c5.513 0 9.998-4.486 9.998-9.998S17.525 2.002 12.01 2.002zM12.01 20.37c-1.666 0-3.3-.448-4.732-1.295l-.339-.2-3.518.922.94-3.43-.22-.349a8.318 8.318 0 0 1-1.312-4.549c0-4.593 3.743-8.337 8.337-8.337s8.336 3.744 8.336 8.337-3.743 8.336-8.336 8.336zm4.577-6.25c-.251-.126-1.486-.734-1.716-.818-.23-.084-.398-.126-.566.126-.168.251-.649.818-.796.985-.147.168-.293.189-.544.063-2.12-.996-3.136-2.072-4.04-3.639-.147-.251-.016-.387.11-.513.113-.113.251-.293.377-.44.126-.146.168-.251.251-.418.084-.168.042-.314-.021-.44-.063-.126-.566-1.362-.776-1.865-.205-.492-.413-.425-.566-.433-.146-.008-.314-.008-.482-.008a.925.925 0 0 0-.671.314c-.23.251-.88.859-.88 2.095s.901 2.43 1.027 2.597c.126.168 1.77 2.702 4.283 3.788 1.956.845 2.51.796 2.972.671.554-.15 1.486-.607 1.696-1.194.21-.586.21-1.089.147-1.194-.063-.105-.23-.168-.482-.293z" />
                  </svg>
                  Connect on WhatsApp
                </a>
              </div>
